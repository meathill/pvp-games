/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 9c5491fa2ab2c0e3d06caa861b1f12bf)
...
declare namespace Cloudflare {
  interface GlobalProps {
    ...
    durableNamespaces: 'DODataExchanger';
  }
  interface Env {
    NEXTJS_ENV: string;
    DO: DurableObjectNamespace /* DODataExchanger */;
