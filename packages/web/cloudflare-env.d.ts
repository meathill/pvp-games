/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 4ef0bfedd990bb2483b1352b0b74a4dd)
// Runtime types generated with workerd@1.20251210.0 2025-11-21 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./.open-next/worker');
  }
  interface Env {
    NEXT_PUBLIC_SIGNALING_URL: 'https://pvp-signaling.roudan.io';
    NEXTJS_ENV: string;
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'NEXT_PUBLIC_SIGNALING_URL' | 'NEXTJS_ENV'>> {}
}
